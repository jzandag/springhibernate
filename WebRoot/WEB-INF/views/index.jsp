...
<%@include file="layout.jsp" %>
    ...
    <style type="text/css">
    	body{
    		backgroud: url("/public/image/stargaze.png");
    	}
    	img.displayed {
		    display: block;
		    margin-left: auto;
		...
		.jumbotron{
			background-image: url("public/image/patch.jpg");
			color: white;
		}
    </style>
...
<div class="container">
	<div class="page-header jumbotron">
	  	<img class="displayed" src="<c:url value="public/image/assassin.png"/>" height="40%" width="30%" 
			alt="Assassin" />
